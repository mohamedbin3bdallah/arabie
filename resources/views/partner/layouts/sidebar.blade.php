    ...
    <section class="sidebar">
      ...
      @if(Auth::User()->role == "partner")
        <ul class="sidebar-menu" data-widget="tree">
		  ...
		  @if(isset($gsetting) && $gsetting->bbl_enable == 1)<li class="{{ Nav::isRoute('bbl.all.meeting') }}"><a href="{{ route('bbl.all.meeting') }}"><i class="flaticon-terms-and-conditions"></i>{{ __('List Meetings') }}</a></li>@endif
        </ul>
      @endif
