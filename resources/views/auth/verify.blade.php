@section('title', __('frontstaticword.verify_email'))
@include('theme.head')
...
<section id="signup" class="signup-block-main-block">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('frontstaticword.verify_text_1') }}</div>

                    <div class="card-body">
                        @if (session('resent'))
                            <div class="alert alert-success" role="alert">
                                {{ __('frontstaticword.verify_text_2') }}
                            </div>
                        @endif

                        {{ __('frontstaticword.verify_text_3') }}
                        {{ __('frontstaticword.verify_text_4') }}, <a href="{{ route('verification.resend') }}">{{ __('frontstaticword.verify_text_5') }}</a>.
                    </div>
                </div>
            </div>
        </div>
