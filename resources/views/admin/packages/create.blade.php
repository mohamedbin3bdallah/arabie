                    ...
                    <form id="demo-form2" method="post" action="{{route('store.package')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="name" id="sub_heading" placeholder="Please enter package name" required>
                            </div>
                            <div class="col-md-2">
                                <label for="rate">{{ __('adminstaticword.numOfHours') }}:<sup class="redstar">*</sup></label>
                                <input class="form-control" type="number" min="1" max="100" name="numOfHours" placeholder="Please enter number of hours" required>
                            </div>
                            <div class="col-md-2">
								...
								<input class="form-control" type="text" name="discountPercentage" placeholder="Please enter discount per hour" required>
                            </div>
                            <div class="col-md-2">
