                    ...
                    <form id="demo-form2" method="post" action="/admins/tax/{{$tax->id}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $tax->name }}" id="sub_heading" placeholder="Please enter language name eg:English" required>
                            </div>
                            <div class="col-md-5">
                                <label for="local">{{ __('adminstaticword.RateIn%') }}:<sup class="redstar">*</sup></label>
                                <input class="form-control" type="number" min="1" max="100" name="rate" value="{{ $tax->rate }}" placeholder="Please enter language local name" required>
                            </div>
