                    ...
                    <form id="demo-form2" method="post" action="{{route('store.tax')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" name="name" id="sub_heading" placeholder="Please enter tax name" required>
                            </div>
                            <div class="col-md-5">
                                <label for="rate">{{ __('adminstaticword.RateIn%') }}:<sup class="redstar">*</sup></label>
                                <input class="form-control" type="number" min="1" max="100" name="rate" placeholder="Please enter tax rate" required>
                            </div>
                            <div class="col-md-2">
