            ...
            <div class="box box-primary">
                ...
                <div class="panel-body">
                    ...
                    <form id="demo-form2" method="post" action="{{route('email.templates.update')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                <label for="booked_successfully_studnet_email">Student Booked Succesffully %tutor% will be replaced with student name: (sent to student)<sup class="redstar">*</sup></label>
                        ...
                        <div class="row">
                            <label for="booked_successfully_tutor_email">Tutor Booked Succesffully Template %student% will be replaced with student name: (sent to tutor) <sup class="redstar">*</sup></label>
                        ...
                        <div class="row">
                            <label for="refund_request_email">Request Refund Template:<sup class="redstar">*</sup></label>
