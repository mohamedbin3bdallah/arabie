	  ...
	  <div class="col-xs-12">
	    <div class="box box-primary" >
	      <div class="box-header with-border">
	        ...
	        <a href=" {{url('admins/state/create')}} " class="btn btn-info btn-sm">+ {{ __('adminstaticword.Add') }} {{ __('adminstaticword.State') }}</a>
		          	...
		          	<tbody>
		                ...
		                @foreach ($states as $state)
			                ...
			                <tr>
			                  ...
			                  <td><form  method="post" action="{{url('admins/state/'.$state->id)}}" data-parsley-validate class="form-horizontal form-label-left">
			                      {{ csrf_field() }}
			                      {{ method_field('DELETE') }}
