      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="panel-heading">
            <a href=" {{url('admins/city')}} " class="btn btn-success pull-right owtbtn">< {{ __('adminstaticword.Back') }}</a>
          </div>

          <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admins/city')}}" data-parsley-validate class="form-horizontal form-label-left">
              {{csrf_field()}}
