	  ...
	  <div class="col-xs-12">
	    <div class="box box-primary" >
	      	<div class="box-header with-border">
	        	...
	        	<a href="{{url('admins/city/create')}} " class="btn btn-info btn-sm">+ {{ __('adminstaticword.Add') }} {{ __('adminstaticword.City') }}</a>
			        ...
			        <table id="example2" class="table table-bordered table-striped table-responsive display nowrap">
		                ...
		                @foreach ($cities as $city)
			                ...
			                <tr>
			                  ...
			                  <td><form  method="post" action="{{url('admins/city/'.$city->id)}}" data-parsley-validate class="form-horizontal form-label-left">
			                      {{ csrf_field() }}
			                      {{ method_field('DELETE') }}
