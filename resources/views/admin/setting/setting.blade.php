...
{{--              <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><i class="flaticon-test" aria-hidden="true"></i> {{ __('adminstaticword.CustomStyleandJS') }}</a></li>--}}
			  ...
			  <li role="presentation"><a href="#payment-settings" aria-controls="payment-settings" role="tab" data-toggle="tab"><i class="flaticon-web-browser" aria-hidden="true"></i>&nbsp;&nbsp;{{ __('adminstaticword.payment_getway') }}</a></li>
            </ul>
            ...
            <div class="tab-content">
			  ...
			  <div role="tabpanel" class="fade tab-pane" id="payment-settings">
                <br>
                 @include('admin.setting.paymentGetway')
              </div>
            </div>
          </div>
        </div>
