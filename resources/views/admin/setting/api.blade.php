                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row" style="{{ $gsetting->vapulus_enabled==1 ? '' : 'display:none' }}" id="vapulus_sec">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $env_files['VAPULUS_WEBSITE_ID'] }}" autofocus name="VAPULUS_WEBSITE_ID" type="text" class="form-control" placeholder="Enter Vapulus Website ID"/>
                                        <br>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="VAPULUS_MERCHANT_ID">{{ __('adminstaticword.VAPULUS_MERCHANT_ID') }}<sup class="redstar">*</sup></label>
                                        <input value="{{ $env_files['VAPULUS_MERCHANT_ID'] }}" autofocus name="VAPULUS_MERCHANT_ID" type="text" class="form-control" placeholder="Enter Vapulus Merchant ID"/>
                                    </div>
                                </div>
                            </div>
                        </div>
