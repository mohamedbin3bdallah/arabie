             ...
             <table id="stuednts_total" class="table table-bordered table-striped table-responsive display nowrap">
				<div class="row status">
				  <div class="col-md-4">
					...
					<h4>
						<span class="label label-pad scheduled">Scheduled</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad waitingConfirm">Waiting for confirmation</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad confirmed">Confirmed</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad cancelled">Cancelled</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad reserved">Reserved</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad waitingResolution">Awaiting resolution</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad pendingPayment">Pending Payment</span>&nbsp;&nbsp;&nbsp;
						<span class="label label-pad label-default">Total</span>
					</h4>
				  </div>
				  <div class="col-md-2">
