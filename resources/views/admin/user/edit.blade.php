          ...
          <form action="{{ route('user.update',$user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input value="{{ ($user->turor_order != 100000) ? $user->turor_order : "" }}" type="number" name="turor_order" placeholder="Enter replacement no" class="form-control">
               </div>
            </div>
...
$('#archive').change(function() {
  ...
  /*$('#uploadVideo').on('change', function() {
      ...
      if (size > 20000000) {
          ...
          $("#uploadVideoLabel").text('file size is greater than 20 MB');
