...
{{--              </div>--}}
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <!--
				-- show option user to user role selection if the user role of the person who create is partner
				-- add option partner to user role selection if the user role of the person who create is admin
				-->
				...
				<select class="form-control js-example-basic-single" name="role" id="role" required>
				  ...
				  <option value="admin" selected>{{ __('adminstaticword.Admin') }}</option>
                  <option value="instructor">{{ __('adminstaticword.Tutor') }}</option>
                </select>
				@endif
              </div>
			  <div class="col-md-3" id="organization">
                <label for="organization">{{ __('adminstaticword.organization') }}: <sup class="redstar">*</sup></label>
				<select class="form-control js-example-basic-single" name="organization" required>
                  <option value="none" selected disabled hidden>
                   {{ __('adminstaticword.SelectanOption') }}
                  </option>
