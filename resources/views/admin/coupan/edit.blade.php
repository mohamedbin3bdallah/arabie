        ...
        <form action="{{ route('coupon.update',$coupan->id) }}" method="POST">
          ...
          <div class="box-body">
              <div class="form-group">
                  ...
                  <input value="{{$coupan->name}}" type="text" class="form-control" id="name" name="name">
                  <span class="text-danger">{{ $errors->has('name') ? $errors->first('name') : '' }}</span>
              </div>
              <div class="form-group">
                  <label>{{ __('Description') }}: <span class="redstar">*</span></label>
                  <input required="" type="text" class="form-control" id="description" name="description" value="{{$coupan->description}}">
              ...
              <div class="form-group">
                  <label>{{ __('Status') }}: <span class="redstar">*</span></label>
{{--                  <option value="0">{{ __('Not Active') }}</option>--}}
                  <select required="" name="status" id="status" class="form-control">

                      <option value="0" @if($coupan->status == 0) selected @endif >{{ __('Not Active') }}</option>
                      <option value="1"  @if($coupan->status == 1) selected @endif >{{ __('adminstaticword.Active') }}</option>
              ...
              <div class="form-group">
                <label>{{ __('Coupon limitation') }}: <span class="redstar">*</span></label>
                <input value="{{ $coupan->maxusage }}" type="number" min="1" class="form-control" name="maxusage">
              </div>

              <div class="form-group">
                  <label>{{ __('Coupon limitation For Single User') }}: <span class="redstar">*</span></label>
                  <input value="{{$coupan->limitationForSingleUser}}" type="number" min="1" class="form-control" name="limitationForSingleUser">
...
{{--                  <span class="input-group-addon"><i class="{{ $currency->icon }}"></i></span>--}}
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input value="{{$coupan->from}}" id="from" type="text" class="form-control" name="from">
