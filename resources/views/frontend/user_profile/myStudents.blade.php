...
@section('pageContent')
    <div class="menubab">
        <div class="container">
            <nav class="setting-menu">
                ...
                <a class="active" href="{{route('myStudents.show',Auth::User()->id)}}">{{ __('frontstaticword.MyStudents') }}</a>
    ...
    <section class="my-teachers">
        <div class="container">
            <h2 class="title">{{ __('frontstaticword.MyStudents') }}</h2>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6 fild">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item"><a class="nav-link active" id="current-tab" data-toggle="tab" href="#current" role="tab" aria-controls="current" aria-selected="true">{{ __('frontstaticword.active') }}</a></li>
{{--                                    <li class="nav-item"><a class="nav-link" id="favourites-tab" data-toggle="tab" href="#favourites" role="tab" aria-controls="favourites" aria-selected="false">{{ __('frontstaticword.archived') }}</a></li>--}}
                                </ul>
                            </div>
                            <div class="col-sm-6 fild">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="current" role="tabpanel" aria-labelledby="current-tab">
                            @foreach($activeStudents as $activeStudent)
                                <div class="item-les">
                                    <div class="sec-les">
                                        <div class="img"><img src="{{ url('/images/user_img/'.$activeStudent->user_img) }}" alt="Arabia" title="Arabia"></div>
                                    </div>
                                    <div class="sec-les">
                                        <div class="minhead">
                                            <h3 class="title">{{$activeStudent->fname}} {{$activeStudent->lname}}.</h3>
{{--                                            <div class="flag" title="{{$activeStudent->country_name}}">  {{country($activeStudent->iso)->getEmoji()}}</div>--}}
                                            <div class="safy">
...
{{--                                            <span class="fas fa-question tooltiptext"><small>Hover over me Hover over me  Hover over me</small>--}}
                                    ...
                                    <div class="sec-les">
                                        <p class="prepaid">{{ __('frontstaticword.price_per_hour') }}</p><span class="text-price">{{$activeStudent->PricePerHour}}</span>
                                    </div>
                                    <div class="sec-les">
...
{{--                                                <a class="dropdown-item" href="#"><i class="far fa-calendar-alt"></i> {{ __('frontstaticword.archive') }}</a>--}}
                                                <a class="dropdown-item sendmessage" href="#" record_id="{{$activeStudent->id}}" timage="{{$activeStudent->user_img}}" data-toggle="modal"><i class="fas fa-comment-alt"></i> {{ __('frontstaticword.send_message') }} </a></div>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
...
{{--                        </div>--}}
                ...
                <div class="col-sm-4 teach-item">
                    <div class="item-datals">
                        <div class="mintitle">
                            <h4>{{ __('frontstaticword.students_list') }}</h4>
                        </div>
                        <div class="images">
                            @foreach($randomStudents as $randomStudent)
                                <img src="{{ url('/images/user_img/'.$randomStudent->user_img) }}" alt="Arabia" title="Arabia">
                            @endforeach
                        </div>
{{--                        <div class="find-tutors"><a href="/findTutor">Find more Tutors</a></div>--}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog popreview">
            <div class="modal-content">
                ...
                <div class="text-center">
                    <h3 class="title">{{ __('frontstaticword.transfer_credits') }}</h3>
                    <p class="mt-2">{{ __('frontstaticword.transfer_text_1') }}</p>
                </div>
                <form action="#">
                    <div class="row">
                        <div class="col-sm-12 fild"><i class="fas fa-chevron-down iconsel"></i>
                            <select class="form-control" name="zone" autocomplete="off" required>
                                <option> </option>
                                <option>{{ __('frontstaticword.choose').' '.__('frontstaticword.tutor') }}</option>
                                <option>{{ __('frontstaticword.choose').' '.__('frontstaticword.tutor') }}</option>
                                <option>{{ __('frontstaticword.choose').' '.__('frontstaticword.tutor') }}</option>
                            </select>
                            <label class="floating-label">{{ __('frontstaticword.transfer_credit').' '.__('frontstaticword.from') }} </label>
                        </div>
                        <div class="col-sm-12 fild"><i class="fas fa-chevron-down iconsel"></i>
                            <select class="form-control" name="zone" autocomplete="off" required>
                                <option> </option>
                            ...
                            <label class="floating-label">{{ __('frontstaticword.add').' '.__('frontstaticword.hours').' '.__('frontstaticword.with') }}</label>
                        </div>
                        <!--div.col-sm-12.fild
                        ...
                        <div class="col-sm-12 fild"><i class="fas fa-chevron-down iconsel"></i>
                            <select class="form-control" name="Reson" autocomplete="off" required>
                                <option> </option>
                                <option>{{ __('frontstaticword.choose') }}</option>
                                <option>{{ __('frontstaticword.choose') }}</option>
                                <option>{{ __('frontstaticword.choose') }}</option>
                            </select>
                            <label class="floating-label">{{ __('frontstaticword.reason') }}</label>
                        </div>
                    </div>
                    <p class="textsacand mt-4"><i class="fas fa-info-circle"></i>  {{ __('frontstaticword.transfer_text_2') }} </p>
                    <div class="fild bot-de bot-card">
                        <button class="bottom" type="submit">{{ __('frontstaticword.confirm') }}</button><a class="bottom" href="#" data-dismiss="modal">{{ __('frontstaticword.cancel') }} </a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="col-sm-12 fild">
                        <textarea class="form-control" name="message" id="messageTextArea"
                            ...
                            <div class="alert alert-danger" role="alert" id="warning">
                                {{ __('frontstaticword.message_text') }} <a href="{{url('terms_condition')}}" title="Terms">{{ __('frontstaticword.Terms&Condition') }}</a>
                            </div>
