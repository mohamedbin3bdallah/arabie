...
<div class="menubab">
    <div class="container">
        <nav class="setting-menu">
            ...
            <a class="active"
                href="{{route('tutorLessons.show',Auth::User()->id)}}">{{ __('frontstaticword.MyLessons') }}</a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8 less-item">
                ...
                <div class="item-les">
                    <div class="sec-les">
                        <div class="img"><img src="{{ $lesson->user_img ? url('/images/user_img/'.$lesson->user_img) : url('/images/general.png') }}" alt="Arabia"
                                title="Arabia"></div>
                    ...
                    <div class="sec-les">
                        ...
                        <ul class="rating">
                            ...
                            class="text-date">{{ $lesson->date .' '. $lesson->start_time  }}
                        </span>
                    ...
                    <div class="sec-les">
                        <h4 class="title">{{ __('frontstaticword.details') }}</h4><span class="text-date">1 {{ __('frontstaticword.hour') }}</span><span
                            class="text-price">{{$tutor->PricePerHour}} USD</span>
                    </div>
                    <div class="sec-les">
                        @if($lesson->status != "Confirmed")
                        ...
                        <div class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">{{ __('frontstaticword.actions') }}<span>
                            ...
                            <div class="dropdown-menu">
                                {{--<a class="dropdown-item" href=""><i class="far fa-calendar-alt"></i> {{ __('frontstaticword.reschedule') }}</a>--}}
                                @if($lesson->status != "Confirmed" && $lesson->status != "Cancelled")
                                <a class="dropdown-item cancelLesson" href="#cancel-lesson" data-toggle="modal"><i
                                        class="far fa-times-circle"></i>{{ __('frontstaticword.cancel') }}</a>
                                @endif
                            </div>
                        </div>
                            @endif
        ...
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <div class="fild bot-de bot-card">
                    <button class="bottom" type="submit">{{ __('frontstaticword.cancel') }}</button><a class="bottom" href="#"
                        data-dismiss="modal">{{ __('frontstaticword.reschedule') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog popreview">
        <div class="modal-content">
            <div class="pop-det">
                ...
                <h3 class="title">Report Issue to Teacher</h3><small>This issue report is sent to your teacher. Your
                    teacher must resolve it within 48 hours.</small>
                <form action="#">
                    <p class="occurred">Select one or more issues that occurred</p>
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <label class="che-box">
                                <input type="checkbox" name="checkbox"><span class="label-text">Student was late</span>
                            </label>
                        </div>
                        <div class="col-sm-12 fild">
                            <label class="che-box">
                        ...
                        <div class="col-sm-12 fild">
                            <textarea class="form-control" name="description" placeholder="Write Comment here…"
                                autocomplete="off" autofocus="" required=""></textarea>
                            <label class="floating-label">Issue comment </label>
                        </div>
                    </div>
                    <div class="fild bot-de bot-card">
                        <button class="bottom" type="submit">Report</button><a class="bottom" href="#"
