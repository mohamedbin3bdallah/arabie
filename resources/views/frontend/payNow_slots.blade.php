                                ...
                                <ul class="listserv">
                                    <li>
                                        <p>
                                            ...
                                            @else
												{{count($cartRecord_array)}} {{ __('frontstaticword.hours').' '.__('frontstaticword.lesson') }}
                                            @endif
                                        </p>
                                    ...
                                    <li>
                                        ...
                                        <span>${{ $offer_price - $discountAmount }}</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="childbox total-det">
                                <h3 class="price-tp">{{ __('frontstaticword.Total') }}
                                    <span>${{ ($offer_price - $discountAmount ) + $transaction_fees }}</span></h3>
                            </div>
                        </div>
                    </div>
                        ...
                        {{--<!-- vapulus pay btn script -->--}}
                            ...
                            @else
                                <div class="text-center">
									...
									@if($offer_price - $discountAmount < $offer_price)
                                    @else
	...
	$("#payNow").on("click", function(){
     ...
     function makePayment() {
					FlutterwaveCheckout({
						...
						country: "US",
						payment_options: " ",
						redirect_url:"https://www.arabie.live/payment-slots/frontend",
						meta: {
							consumer_id: "{{$user->id}}",
						...
						callback: function (data) {
                            ...
                            if(status === "successful"){
                                window.location.href = `https://www.arabie.live/payment-slots/frontend?status=${status}`;
                            }
						},
						onclose: function() {
							// close modal
