...
@section('title', __('frontstaticword.lesson_has_not_started'))
        ...
        <div class="container" style="height: 100% !important;">
            ...
            @if($sessionPassed == 1)
                <h2 style="margin-left: 120px ;margin-bottom: 70px">
                    {{ __('frontstaticword.lesson_has_not_started_text_1') }}
                </h2>
            @else
                    <h2 style="margin-left: 120px ;margin-bottom: 70px">
                        {{ __('frontstaticword.lesson_has_not_started_text_2') }}
                    </h2>
<br>
            <?php
            ...
            <h3 style=" margin-left: 300px ;margin-bottom: 70px;color: #af8b62">
                {{ __('frontstaticword.start_at') }} {{$correct_time}}
            </h3>
            <br>
                    <h4 style="margin-left: 120px ;margin-bottom: 70px">
                        {{ __('frontstaticword.lesson_has_not_started_text_3') }}
