...
@section('title', __('frontstaticword.messages'))
@section('pageContent')
<script
...
<div class="container">
   <h5>  {{ __('frontstaticword.messages').' '.__('frontstaticword.with') }} {{$user->fname}} {{$user->lname}} </h5>
   <div class="messaging">
      <div class="inbox_msg">
         <div class="mesgs">
            ...
            <div class="type_msg">
               <div class="input_msg_write">
                  <form action="{{ route('send.message') }}" method="POST">
                     ...
                     <input type="text" class="write_msg" id="messageTextArea" name="message" placeholder="{{ __('frontstaticword.type_a_message') }}" required />
                     <button class="msg_send_btn" id="message_submit" type="submit"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
                     <div class="alert alert-danger" role="alert" id="warning">{{ __('frontstaticword.type_a_message_text') }} <a href="{{url('terms_condition')}}" title="Terms">{{ __('frontstaticword.Terms&Condition') }}</a>
                  </form>
                  </div>
               </div>
            </div>
