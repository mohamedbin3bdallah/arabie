...
<div class="menubab">
    <div class="container">
        <nav class="setting-menu">
            ...
            <a class="active" href="/tutor/profile">{{ __('frontstaticword.UserProfile') }}</a>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        <ul class="nav nav-tabs tabs-tutor" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link active" id="item-1-tab" data-toggle="tab" href="#item-1" role="tab"
                    aria-controls="item-1" aria-selected="true">{{ __('frontstaticword.About') }}</a></li>
            <li class="nav-item"><a class="nav-link" id="item-2-tab" data-toggle="tab" href="#item-2" role="tab"
                    aria-controls="item-2" aria-selected="false">{{ __('frontstaticword.ProfileDescription') }}</a></li>
            <li class="nav-item"><a class="nav-link" id="item-3-tab" data-toggle="tab" href="#item-3" role="tab"
                    aria-controls="item-3" aria-selected="false">{{ __('frontstaticword.Video') }}</a></li>
            <li class="nav-item"><a class="nav-link" id="item-4-tab" data-toggle="tab" href="#item-4" role="tab"
                    aria-controls="item-4" aria-selected="false">{{ __('frontstaticword.ProfileVerification') }}</a>
            </li>
            <li class="nav-item"><a class="nav-link" id="item-5-tab" data-toggle="tab" href="#item-5" role="tab"
                    aria-controls="item-5" aria-selected="false">{{ __('frontstaticword.Resume') }}</a></li>
            <li class="nav-item"><a class="nav-link" id="item-6-tab" data-toggle="tab" href="#item-6" role="tab"
                    aria-controls="item-6" aria-selected="false">{{ __('frontstaticword.Password') }}</a></li>
            <li class="nav-item"><a class="nav-link" id="item-7-tab" data-toggle="tab" href="#item-7" role="tab"
                    aria-controls="item-7" aria-selected="false">{{ __('frontstaticword.Notifications') }}</a></li>
        </ul>
                ...
                <div class="row">
                    <div class="col-sm-8 itemform">
                        <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 fild">
                                    <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter_your_lname') }}"
                                        @if(isset($tutor->user->fname)) value="{{$tutor->user->lname}}" @endif
                                ...
                                <div class="col-sm-12 fild">
                                    <input class="form-control" type="email" readonly name="email"
                                        ...
                                        autocomplete="off" @if(isset($tutor->user->email))
                                ...
                                <div class="col-sm-12 fild"><i class="fas fa-chevron-down iconsel"></i>
                                    <select class="form-control required" name="country_residence" autocomplete="off" autofocus
                                        required>
                                        @foreach($countries as $country)
                                ...
                                <div class="col-sm-12 add-fild">
                                    <div class="row">
                                        <div class="col-sm-6 fild"><i class="fas fa-chevron-down iconsel"></i>
                                            <select class="form-control required" name="Language" autocomplete="off"
                                                autofocus required>
                                        ...
                                        <div class="col-sm-6 fild"><i class="fas fa-chevron-down iconsel"></i>
                                            <select class="form-control required" name="Level" autocomplete="off"
                                                autofocus required>
                                    ...
                                    </div><span class="bottom style-add add"><i class="fas fa-plus"></i></span>
                                </div>
                                ...
                                <div class="col-sm-12 fild"><span class="ealamuh">$</span>
                                    <input class="form-control" type="number" min="1" max="500" placeholder="$"
                                ...
                                <div class="col-sm-12 fild">
                                    <input class="form-control mobile" type="text" placeholder="{{ __('frontstaticword.enter_your_mobile') }}"
                                        @if(isset($tutor->user->mobile)) value="{{$tutor->user->mobile}}" @endif
                                ...
                                <div class="col-sm-12 fild"><i class="fas fa-chevron-down iconsel"></i>
                                    <select class="form-control required" name="specialty" required>
                                        <option> </option>
                                        @foreach($specialties As $specialty)
                                        <option @if(isset($tutor->specialty)) @if($specialty->id == $tutor->specialty)
                                            selected @endif @endif
                                            value="{{$specialty->id}}">{{ __ ('frontstaticword.'.$specialty->specialty)}}
                                        </option>
                                        @endforeach
                                        $tutorSpecialties
                                    </select>
                            ...
                            <h2 class="title sh__m">{{ __('frontstaticword.financial_info') }}</h2>
                            <div class="bank-account">
                                <div class="head-title d-flex">
                                    <span>{{ __('frontstaticword.bank_account') }}</span>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 fild">
                                        <input class="form-control" type="number" name="account_number"
                                            @if(isset($tutorPaymentInfo->account_number))
                                        value="{{$tutorPaymentInfo->account_number}}" @endif placeholder="{{ __('frontstaticword.enter') }}"
                                        autocomplete="off"
                                        autofocus>
                                        <label class="floating-label">{{ __('frontstaticword.account_number') }}</label>
                                    </div>
                                    <div class="col-sm-12 fild">
                                        <input class="form-control" type="text" name="iban"
                                            @if(isset($tutorPaymentInfo->iban)) value="{{$tutorPaymentInfo->iban}}"
                                        @endif placeholder="{{ __('frontstaticword.enter') }}" autocomplete="off"
                                        autofocus>
                                        <label class="floating-label">{{ __('frontstaticword.iban') }}</label>
                                    </div>
                                    <div class="col-sm-12 fild">
                                        ...
                                        autofocus>
                                        <label class="floating-label">{{ __('frontstaticword.account_name') }}</label>
                                    </div>
                                </div>
                                {{--                                <div class="head-title d-flex">--}}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="item-bank">
                                            ...
                                            <div class="account-name d-flex">
                                                <span> {{$tutorPaymentInfo->account_name}} </span><a href="#"
                                                    class="bottom btn-remove deletePaymentInfo"
                                                    id="{{$tutorPaymentInfo->id}}"><i class="fas fa-trash"></i></a>
                                            </div>
                                            @endif
                                            <div class="bank-num">
                                                {{--                                                <span> **** **** **** **12 </span>--}}
                        ...
                        <div class="col-sm-10 prin-item">
                            ...
                            <div class="row">
                                <div class="col-sm-3 item-tab">
                                    <div class="imgcent"><img class="img_prev"
                                    ...
                                    <h3 class="title siza mt-4">{{ __('frontstaticword.profile_upload_photo_text_1') }}</h3>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                                    ...
                                                    <path id="Path_31915" data-name="Path 31915"
                                                        d="M25.98,6l-9.6,9.61L13.5,12.73"
                                                        transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1.5"></path>
                                                </g>
                                ...
                                <div class="col-sm-8 offset-sm-1 item-tab2">
                                    <div class="row">
                                        <div class="col-sm-12 fild">
                                            <input class="form-control" type="text"
                                                placeholder="{{ __('frontstaticword.enter') }}"
                                                @if(isset($tutor->headline)) value="{{$tutor->headline}}" @endif
                                        ...
                                        <div class="col-sm-12 fild">
                                            <textarea class="form-control" name="detail" autocomplete="off" autofocus
                                            ...
                                            <p class="textsacand"><i class="fas fa-info-circle"></i> <span
                                                    id="remain">250 </span> {{ __('frontstaticword.characters_minimum') }} 0 {{ __('frontstaticword.characters_currently') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-7 itemform">
                            <div class="item-us" id="div1" @if($tutor->youtube_url == null) style="display: none" @endif
                                >
                                <div class="iframe">
                                    <iframe src="{{Auth::user()->youtube_url}}" allowTransparency="true"
                                        allow="encrypted-media"></iframe>
                                </div>
                                <h4 class="title siza mt-5">{{ __('frontstaticword.upload_new_video') }}</h4><span class="great">{{ __('frontstaticword.paste_a_link_to_your_video') }}</span>
                                <p class="textsacand"><i class="fas fa-info-circle"></i> {{ __('frontstaticword.learn_how_to_upload_videos_to') }}
                                    <a href="https://www.youtube.com/create_channel?next=https%3A%2F%2Fstudio.youtube.com%2Fchannel%2FUC%2Fvideos%3Fd%3Dud"
                                        target="_blank">Youtube </a> {{ __('frontstaticword.or') }} <a href="https://vimeo.com/upload"
                                        target="_blank">Vimeo </a>
                                </p>
                                <div class="fild">
                                    <input class="form-control" type="url"
                                        placeholder="www.youtube.com/watch?v=l5aZJBLAu1E"
                                        value="{{\Illuminate\Support\Facades\Auth::user()->youtube_url}}" name="url"
                            ...
                            {{--                            </nav>--}}
                            {{--                        </div>--}}
                            <div id="div2" @if($tutor->video == null) style="display: none" @endif class="hide"><span
                                    class="great">{{ __('frontstaticword.or_upload_your_video') }}</span>
                                <div class="custom-file">
                                    <input class="custom-file-input" type="file" id="uploadVideo"
                                        accept="video/mp4,video/x-m4v,video/*" name="uploadVideo">
                                    <label class="custom-file-label" for="customFile">no file </label>
                                </div>
                                <video class="player-course-chapter-list" loop muted
                        ...
                        <div class="col-sm-4 itemform offset-sm-1">
                            ...
                            <ul class="list-item">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        transform="translate(-2.248 -2.229)">
                                        <path id="Path_31914" data-name="Path 31914"
                                            d="M22.2,11.714V12.6a9.6,9.6,0,1,1-5.693-8.775" transform="translate(0 0)"
                                            fill="none" stroke="#ba9a74" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5"></path>
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_1') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_2') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_3') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_4') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_5') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_6') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_7') }}
                                </li>
                            </ul>
                            <ul class="list-item">
                                ...
                                <li>
                                    ...
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_8') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_9') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_10') }}
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        viewBox="0 0 21.013 20.726"></svg>
                                    <g id="Icon_feather-check-circle" data-name="Icon feather-check-circle"
                                        ...
                                        <path id="Path_31915" data-name="Path 31915" d="M25.98,6l-9.6,9.61L13.5,12.73"
                                            transform="translate(-3.78 -1.083)" fill="none" stroke="#ba9a74"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </g>{{ __('frontstaticword.profile_upload_video_text_11') }}
                                </li>
                            </ul>
                        </div>
            ...
            <div class="tab-pane fade" id="item-4" role="tabpanel" aria-labelledby="item-4-tab">
                ...
                <div class="col-sm-8 itemform">
                    <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <a style=" color: #af8b62" href="{{ asset('files/instructor/'.$tutor['file']) }}"
                                download="{{$tutor['file']}}">{{ __('adminstaticword.Download') }} <i
                                    class="fa fa-download" style=" color: #af8b62"></i></a>
                            {{--                        <div class="textmap fletext"><i class="fas fa-check"> </i><span>profile ID is verified</span></div>--}}
                            <h4 class="title siza mt-5">{{ __('frontstaticword.upload_new_document') }}</h4>
                            <div class="custom-file">
                ...
                <div class="edit-all">
                    <div class="item-edit">
                        <div class="head-title">
                            <h5 class="title">{{ __('frontstaticword.education') }} </h5><a class="bottom style-add" href="#add-item-education"
                                data-toggle="modal"><i class="fas fa-plus"></i></a>
                        </div>
                        ...
                        <div class="row-tow">
                            ...
                            <div class="primary">
                                <div class="head-title">
                                    <h5 class="title">{{$education->university}} </h5><a class="bottom style-add"
                                        href="#edit-education" data-toggle="modal"><i class="fas fa-pen edit-edu"
                                            data_id="{{$education->id}}"></i></a>
                                    <a class="bottom style-add" href="/tutor/education/delete/{{$education->id}}"><i
                                            class="fas fa-trash" data_id="{{$education->id}}"></i></a>
                            ...
                            <div class="textmap revie"><i class="fas fa-unlock-alt"> </i>
                                <p>{{ __('frontstaticword.education_text_1') }} </p><span>{{ __('frontstaticword.education_text_2') }}</span>
                            </div>
                        </div>
                        @endif
                        @endforeach
                    ...
                    <div class="item-edit">
                        <div class="head-title">
                            <h5 class="title">{{ __('frontstaticword.work_experience') }} </h5><a class="bottom style-add"
                                href="#add-item-experience" data-toggle="modal"><i class="fas fa-plus"></i></a>
                        </div>
                        ...
                        <div class="row-tow">
                            ...
                            <div class="primary">
                                <div class="head-title">
                                    <h5 class="title">{{$experience->company}}</h5><a class="bottom style-add"
                                        href="#edit-work" data-toggle="modal"><i class="fas fa-pen"></i></a>
                                    <a class="bottom style-add" href="/tutor/experience/delete/{{$experience->id}}"><i
                                            class="fas fa-trash" data_id="{{$experience->id}}"></i></a>
                    ...
                    <div class="item-edit">
                        <div class="head-title">
                            <h5 class="title">{{ __('frontstaticword.certifications') }}</h5><a class="bottom style-add" href="#add-item-certificate"
                                data-toggle="modal"><i class="fas fa-plus"></i></a>
                        </div>
                        ...
                        <div class="row-tow">
                            ...
                            <div class="primary">
                                <div class="head-title">
                                    <h5 class="title">{{$certificate->certificate}}</h5><a class="bottom style-add"
                                        href="#edit-certificate" data-toggle="modal"><i class="fas fa-pen"></i></a>
                                    <a class="bottom style-add" href="/tutor/certificate/delete/{{$certificate->id}}"><i
                                            class="fas fa-trash" data_id="{{$certificate->id}}"></i></a>
                ...
                <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-8 item-tab2">
                            <div class="row">
                                <div class="col-sm-12 fild">
                                    <input class="form-control" type="password" placeholder="{{ __('frontstaticword.enter_your_password') }}"
                                        name="oldPassword" autocomplete="off" autofocus required>
                                    <label class="floating-label">{{ __('frontstaticword.current').' '.__('frontstaticword.Password') }}</label><a class="forget"
                                        href="{{ '/password/reset' }}">{{ __('frontstaticword.ForgotPassword') }}</a>
                                </div>
                                <div class="col-sm-12 fild">
                                    <input class="form-control" type="password" minlength="8" maxlength="100"
                                        placeholder="{{ __('frontstaticword.enter_a_password') }}" name="password" autocomplete="off" autofocus
                                        required>
                                    <label class="floating-label">{{ __('frontstaticword.new').' '.__('frontstaticword.Password') }}</label>
                                    <span
                                ...
                                <div class="col-sm-12 fild">
                                    <input class="form-control" type="password" minlength="8" maxlength="100"
                                        placeholder="{{ __('frontstaticword.enter_confirm_password') }}" name="vPassword" autocomplete="off" autofocus
                                        required>
                                    <label class="floating-label">{{ __('frontstaticword.verify').' '.__('frontstaticword.Password') }}</label>
                                    <span
                                        class="text-danger">{{ $errors->has('vPassword') ? $errors->first('vPassword') : '' }}</span>
                    ...
                    <div class="row">
                        <div class="col-sm-12 prin-item">
                            ...
                            <div class="check-notif">
                                ...
                                <label class="che-box">
                                    <input type="checkbox" @foreach($tutorNotificationsSettings as
                                        $tutorNotificationsSetting)@if(in_array($tutorNotificationsSetting->type_id ==
                            ...
                            <div class="bot-all">
                                <button class="bottom" type="submit">{{ __('frontstaticword.save') }}
                                    {{ __('frontstaticword.settings') }}</button><a class="bottom last-bot"
                                    href="/tutor/Unsubscribe">{{ __('frontstaticword.unsubscribe_them_all') }} </a>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.edit').' '.__('frontstaticword.bank_account') }}</h3>
                <form action="{{ route('tutor.experience.update') }}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="number" name="account_number" placeholder="{{ __('frontstaticword.enter') }}"
                                @if(isset($tutorPaymentInfo->account_number))
                        ...
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" name="iban" placeholder="{{ __('frontstaticword.enter') }}"
                                @if(isset($tutorPaymentInfo->iban)) value="{{$tutorPaymentInfo->iban}}" @endif
                            autocomplete="off" autofocus>
                            <label class="floating-label">{{ __('frontstaticword.iban') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" name="account_name" placeholder="{{ __('frontstaticword.enter') }}"
                                @if(isset($tutorPaymentInfo->account_name)) value="{{$tutorPaymentInfo->account_name}}"
                            @endif
                            autocomplete="off" autofocus>
                            <label class="floating-label">{{ __('frontstaticword.account_name') }}</label>
                        </div>
                    ...
                    <div class="fild bot-de bot-card">
                        <button class="bottom" type="submit">{{ __('frontstaticword.save') }}</button><a class="bottom" href="#"
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.edit').' '.__('frontstaticword.education') }} </h3>
                <form action="{{ route('tutor.education.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12 fild">
                            ...
                            value="{{$education->university}}" @endif placeholder="" name="university"
                            autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.university/college') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            ...
                            autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.degree') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            ...
                            autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.specialty') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
                            <input class="form-control" type="date" @if(isset($education->from))
                            value="{{$education->from}}" @endif placeholder="{{ __('frontstaticword.enter') }}" name="from" autocomplete="off"
                            autofocus required>

                            <label class="floating-label">{{ __('frontstaticword.from') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
                            ...
                            required>
                            <label class="floating-label">{{ __('frontstaticword.to') }} </label>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.edit').' '.__('frontstaticword.work_experience') }}</h3>
                <form action="{{ route('tutor.experience.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 fild">
                        ...
                        <div class="col-sm-12 fild">
                            ...
                            <label class="floating-label">{{ __('frontstaticword.Title') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.edit').' '.__('frontstaticword.certificate') }} </h3>
                <form action="{{ route('tutor.certificate.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}"
                                @if(isset($certificate->certificate)) value="{{$certificate->certificate}}" @endif
                            name="certificate" autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.certificate') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}"
                                @if(isset($certificate->description)) value="{{$certificate->description}}" @endif
                            name="description" autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.Description') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="issuedBy"
                                @if(isset($certificate->Issuedby)) value="{{$certificate->Issuedby}}" @endif
                            autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.issued_by') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.add').' '.__('frontstaticword.education') }}</h3>
                <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data"
                    id="form_modal">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="college"
                                autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.university/college') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="Degree" autocomplete="off"
                                autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.degree') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="speciality"
                                autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.specialty') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
                            <input class="form-control" type="date" placeholder="{{ __('frontstaticword.enter') }}" name="from" autocomplete="off"
                                autofocus required>

                            <label class="floating-label">{{ __('frontstaticword.from') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
                            <input class="form-control" type="date" placeholder="{{ __('frontstaticword.enter') }}" name="to" autocomplete="off"
                                autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.to') }} </label>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.add').' '.__('frontstaticword.work_experience') }}</h3>
                <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data"
                    id="form_modal">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="company"
                                autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.company_name') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="title" autocomplete="off"
                                autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.Title') }}</label>
                        </div>
                        <div class="col-sm-6 fild">
    ...
    <div class="modal-dialog">
        <div class="modal-content deleting">
            <div class="pop-det">
                ...
                <h3 class="title">{{ __('frontstaticword.add').' '.__('frontstaticword.certificate') }}</h3>
                <form action="{{ route('tutor.profile.update') }}" method="post" enctype="multipart/form-data"
                    id="form_modal">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="certificate"
                                autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.certificate') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
                            <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter') }}" name="description"
                                autocomplete="off" autofocus required>
                            <label class="floating-label">{{ __('frontstaticword.Description') }}</label>
                        </div>
                        <div class="col-sm-12 fild">
...
$(function() {
    ...
    $("#form_modal").validate({
        ...
        messages: {
            from: {
                required: "{{ __('frontstaticword.please_enter_some_data') }}",
