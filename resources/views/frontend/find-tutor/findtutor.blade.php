...
@section('pageContent')
    ...
    <div class="container">
        <div class="headtitle">
            <h1 class="title">{{ __('frontstaticword.find_a_tutor_text') }}</h1>
            <span class="num-to">{{$tutors->total()}} {{ __('frontstaticword.tutors') }}</span>
        </div>
        <div class="headtext">
            {{--<p class="textline"> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet</p>--}}
            <div class="onclick"><span class="more">+ {{ __('frontstaticword.readMore') }}</span><span class="cancel">X {{ __('frontstaticword.hide') }}</span></div>
            <p class="divhidslid">{{ __('frontstaticword.find_a_tutor_description') }}</p>
        </div>
        <div class="prin-item">
            <h2 class="title">{{ __('frontstaticword.filter_by') }}</h2>
            <form class="filter-item" action="{{route('findTutor.search')}}" method="get">
				...
				<div class="row">
                    <div class="col-sm-2 sel-filt" style="max-width:33.333333%;">
                        <div class="availability" id="availability">{{ __('frontstaticword.availability') }}
                            <div class="inner-ava">
                                <div class="times-day">
                                    <h3 class="title">{{ __('frontstaticword.time_of_the_day') }}</h3>
                                    <div class="row">
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sunrise.png"
                                                    ...
                                                    <small>6-9</small>
                                                    <p>{{ __('frontstaticword.morning') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sunrise2.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>9-12</small>
                                                    <p>{{ __('frontstaticword.late_morning') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sun.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>12-15</small>
                                                    <p>{{ __('frontstaticword.afternoon') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sun.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>15-18</small>
                                                    <p>{{ __('frontstaticword.late_afternoon') }} </p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sunrise3.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>18-21</small>
                                                    <p>{{ __('frontstaticword.evening') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/half-moon.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>21-24</small>
                                                    <p>{{ __('frontstaticword.late_evening') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-3 ch-item">
                                        ...
                                        <div class="col-sm-3 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text"><img src="/frontAssets/images/sleep.png"
                                                        alt="Arabia" title="Arabia">
                                                    <small>3-6</small>
                                                    <p>{{ __('frontstaticword.late_night') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="times-day week">
                                    <h3 class="title">{{ __('frontstaticword.days_of_the_week') }}</h3>
                                    <div class="row">
                                        <div class="col-sm-2 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text">
                                                    <p>{{ __('frontstaticword.Saturday') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 ch-item">
                                        ...
                                        <div class="col-sm-2 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text">
                                                    <p>{{ __('frontstaticword.Tuesday') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text">
                                                    <p>{{ __('frontstaticword.Wednesday') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 ch-item">
                                            <label class="chebox-time">
                                                ...
                                                <div class="label-text">
                                                    <p>{{ __('frontstaticword.Thursday') }}</p>
                                                </div>
                                            </label>
                                        </div>
                                        <div class="col-sm-2 ch-item">
                    ...
                    <div class="col-sm-2 sel-filt" style="max-width:33.333333%;">
                        <input class="form-control" type="text" placeholder="{{ __('frontstaticword.search_by_name') }}" name="searchWord" value="@if(request()->searchWord != '') {{request()->searchWord}} @endif" id="searchBox">

                    </div>
                </div>
                <div class="filter-text">
                    <h3 class="title">{{ __('frontstaticword.find_your_tutor') }}</h3>
                    <div class="fil-search">
                        <div class="select-short">
                            <p>{{ __('frontstaticword.sort_by') }}</p>
                            <select class="chosen-select" data-placeholder="{{ __('frontstaticword.popularity') }}" name="sort" tabindex="5"
                                id="sort">
                                <option value=""></option>
                                <option value="Popularity" @if(request()->sort == 'Popularity') {{'selected'}} @endif>{{ __('frontstaticword.popularity') }}</option>
                                <option value="highestPrice" @if(request()->sort == 'highestPrice') {{'selected'}} @endif>{{ __('frontstaticword.price_highest_first') }}</option>
                                <option value="lowestPrice" @if(request()->sort == 'lowestPrice') {{'selected'}} @endif>{{ __('frontstaticword.price_lowest_first') }}</option>
                                <option value="Reviews" @if(request()->sort == 'Reviews') {{'selected'}} @endif>{{ __('frontstaticword.Reviews') }}</option>
                                <option value="Ratings" @if(request()->sort == 'Ratings') {{'selected'}} @endif>{{ __('frontstaticword.ratings') }}</option>
                            </select>
                        </div>
                ...
                <div class="row w-100 mt-4 align-items-center d-flex justify-content-between">
                    <div class="col-6 sel-filt check-item">
                        <label class="che-box">
                            <input type="checkbox" id="nativeSpeaker" name="checkbox" @if(request()->checkbox == 'on') {{'checked'}} @endif><span class="label-text">{{ __('frontstaticword.native_speaker') }}</span>
                        </label>
                    </div>
                    <button class="btn bottom"> {{ __('frontstaticword.search') }}</button>
                                ...
                                <div class="tu-photo">
									...
									@if(Auth::check() && Auth::user()->role == 'user' || Auth::guest())
										<div class="fild bot-de bot-card">
											<button class="bottom booknow" record_id="{{$tutor->id}}" tname="{{$tutor->user->fname}} {{$tutor->user->lname}}" timage="{{$tutor->user->user_img}}" tutor_id="{{$tutor->id}}">{{ __('frontstaticword.book_now') }}</button>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('messages.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 fild">
                        <textarea class="form-control" name="message" id="messageTextArea"
                            ...
                            <div class="alert alert-danger" role="alert" id="warning">{{ __('frontstaticword.message_text') }} <a href="{{url('terms_condition')}}" title="Terms">{{ __('frontstaticword.Terms&Condition') }}</a>
                            </div>
                ...
                <div class="fild bot-de bot-card">
                    ...
                    <a class="bottom" href="#" data-dismiss="modal">{{ __('frontstaticword.cancel') }} </a>
                </div>
            </form>
        </div>
    </div>
