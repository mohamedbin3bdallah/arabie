        ...
        <div class="prin-item">
            ...
            <form class="filter-item" action="{{route('findTutor.search')}}" method="get">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 sel-filt">
                        <select class="country" data-max="" name="country[]" data-placeholder="Country"
                    ...
                    <div class="col-sm-2 sel-filt">
                        <input class="form-control" type="text" placeholder="Search By Name" name="searchWord"
                            id="searchBox">
                                ...
                                <div class="tu-photo">
                                    ...
                                    <div class="fild bot-de bot-card">
                                        <a class="bottom book-trial bookingBottom" href="#booktrial{{$tutor->id}}"
                                            ...
                                            timage="{{$tutor->user->user_img}}" data-toggle="modal">Book Now</a>
            ...
            @php $x++; @endphp
                ...
                <div class="box-book-trial myModal" id="#booktrial{{$tutor->id}}">
                    <div class="modal-content">
                        ...
                        <div class="photo" style="margin-top: -30px !important;"><img src="{{ url('/images/user_img/'.$tutor->user->user_img) }}" class="bookingImage" alt=""
                                                title=""></div>
