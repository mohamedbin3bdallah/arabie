...
@section('title', __('frontstaticword.my_favourites'))
    ...
    <section class="findtutor">
        <div class="container">
            <div class="headtitle favo">
                <h1 class="title">{{ __('frontstaticword.my_favourites') }}</h1><span class="num-to">@if(isset($favouriteTutorsCount)){{$favouriteTutorsCount}}@endif {{ __('frontstaticword.tutors') }}</span>
            </div>
                    ...
                    @foreach($favouriteTutors as $tutor)
                                ...
                                <div class="col-sm-8 contenuser hoverbox">
                                    <div class="itemtutor">
                                        <div class="flex-box">
                                            <div class="tu-photo">
                                                <div class="img">
                                                    {{--                                            <span class="featured">{{ __('frontstaticword.featured') }}</span>--}}
                                                ...
                                                <div class="price-to">USD/{{ __('frontstaticword.hour') }}</div>
                                                <div class="fild bot-de bot-card">
                                                    <a class="bottom book-trial bookingBottom" href="#booktrial{{$tutor->id}}"
                                                       record_id="{{$tutor->id}}"
                                                       tname="{{$tutor->user->fname}} {{$tutor->user->lname}}"
                                                       timage="{{$tutor->user->user_img}}" data-toggle="modal">{{ __('frontstaticword.book_now') }}</a>
                                                    <a class="bottom" href="#sendmessage" record_id="{{$tutor->id}}"
                                                       tname="{{$tutor->user->fname}} {{$tutor->user->lname}}"
                                                       headline="{{$tutor->headline}}" timage="{{$tutor->user->user_img}}"
                                                       data-toggle="modal">{{ __('frontstaticword.send_message') }}</a>
                                                </div>
                                            </div>
                                            <div class="tu-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 itemactiv">
                                                        <div class="mactiv"><img src="/frontAssets/images/mactiv1.png" alt="Arabia"
                                                                                 title="Arabia">
                                                            <div class="con-item">
                                                                <h4 class="title">{{ __('frontstaticword.active_students') }}</h4>
                                                    ...
                                                    <div class="col-sm-4 itemactiv">
                                                        <div class="mactiv"><img src="/frontAssets/images/clock.png" alt="Arabia"
                                                                                 title="Arabia">
                                                            <div class="con-item">
                                                                <h4 class="title">{{ __('frontstaticword.lessons') }}</h4><span>{{count($tutor->bookedSlots)}}
                                                    </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 itemactiv">
                                                        <div class="mactiv"><img src="/frontAssets/images/review.png" alt="Arabia"
                                                                                 title="Arabia">
                                                            <div class="con-item">
                                                                <h4 class="title">{{ __('frontstaticword.Reviews') }}</h4><span>{{count($tutor->reviews)}}
                                                    </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="headtext">
                                                    ...
                                                    <div class="onclick"><span
                                                            ...
                                                            class="cancel">X {{ __('frontstaticword.hide') }}</span></div>
                                    ...
                                    @if($tutor->user->youtube_url == null)
                                        ...
                                        @if(strtolower(end($video)) == 'mov')
                                            ...
                                            @else
                                                ...
                                                <div class="iframe">
                                                    <a data-fancybox data-width="780" data-height="440"
                                                       href="{{ asset('files/instructor/'.$tutor->video) }}">
                                        ...
                                        <p class="timezone"><i class="fas fa-globe-americas"></i>&nbsp; {{ __('frontstaticword.tutor_content_text') }} </p>
                                        <div class="calandar-wek">

                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item"><a class="nav-link active" id="item-1-tab" data-toggle="tab"
                                                                        href="#item-1" role="tab" aria-controls="item-1" aria-selected="true"> </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                @foreach($tutor->schedule->groupBy('day') as $day => $schedule)
                                                    ...
                                                    <div class="tab-pane fade show active" id="item-1" role="tabpanel"
                                                        ...
                                                        <div class="times-day">
                                                            <h3 class="title">{{__('frontstaticword.'.$day)}}</h3>
                                                            <div class="row">
                                                                        ...
                                                                        <label class="chebox-time">
                                                                            ...
                                                                            <div class="label-text">
																				...
																				<div class="active" id="ck-button" style="padding:9px 0px;">
                                                                                    ...
                                                                                    @endphp
																						<input type="checkbox" id="checkbox_slots_detals" name="slots[]" value="{{$tutor->id.','.$last_week[$day].','.substr($slot_time, 0, 5)}}">
                                                ...
                                                @endforeach
                                                <div class="text-center"><button type="submit" class="bottom booknow" id="checkBtn_details">{{ __('frontstaticword.Submit') }}</button></div>
												<div class="text-center"><a class="bottom" href="/tutor/page/{{$tutor->id}}">{{ __('frontstaticword.view_full_schedule') }}</a></div>
                        ...
                        <div class="box-book-trial myModal" id="#booktrial{{$tutor->id}}">
                            <div class="modal-content">
                                ...
                                <div class="photo" style="margin-top: -10px !important;"><img src="{{ url('/images/user_img/'.$tutor->user->user_img) }}" class="bookingImage" alt=""
                                                        title=""></div>
                                <div class="text-center mt-4">
                                    <h3 class="title">{{ __('frontstaticword.instant_booking') }}</h3>
                                    <p class="mt-2"> {{ __('frontstaticword.tutor_slots_text') }} </p>
                                </div>
								...
								<form action="/slots/appointment" method="get" enctype="multipart/form-data" class="bookingForm" onsubmit="myButton.disabled = true;" id="slots_form">
                                    ...
                                    <div class="responsive">
										...
										<div>
                                            <div class="between">
                                                <p class="day-ma">{{$week_first_day.' '.__('frontstaticword.'.$week_first_month).' '.$week_first_year}}  {{ __('frontstaticword.to') }}  {{$week_last_day.' '.__('frontstaticword.'.$week_last_month).' '.$week_last_year}} </p>
                                                <p class="timezone"><i class="fas fa-globe-americas"></i> {{ __('frontstaticword.tutor_slots_week_text_1') }}</p>
                                                <p class="textsacand"><i class="fas fa-info-circle"></i> {{ __('frontstaticword.tutor_slots_week_text_2') }}</p>
                                            </div>
                                            <div class="num-book">
                                                <div class="row">
                                                    ...
                                                    @while($dayOfWeek < \Carbon\Carbon::today()->addDay(7))
                                                        <div class="col innerbook">
                                                            <div class="innernum active">
                                                                <p class="sat active">{{__('frontstaticword.'.$dayOfWeek->format('l'))}}</p>
                                                                        ...
                                                                        <!--<nav class="listnum">-->
                                                                            ...
                                                                            @while($currentTime < $schedule->getOriginal('end_time'))
                                                                                ...
                                                                                @else
																					...
																					<li id="ck-book" class="active"><label><span>{{ __('frontstaticword.booked') }}</span></label></li>
                                                                                @endif
                                                        ...
                                                        <div>
                                                            <button type="submit" id="submitBooking" class="submitBooking" name="myButton" hidden="hidden">{{ __('frontstaticword.search') }}</button>
                                                        </div>
                                    ...
                                    <div class="bot-de bot-card modal_sticky_footer">
										<button type="submit" class="bottom booknow" id="checkBtn">{{ __('frontstaticword.Submit') }}</button>
                                        <span class="bottom clo-item">{{ __('frontstaticword.cancel') }} </span>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <form action="#">
                        <div class="row">
                            <div class="col-sm-6 fild">
                                <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter_your_fname') }}" name="Firstname" autocomplete="off" autofocus required>
                                <label class="floating-label">{{ __('frontstaticword.fname') }}</label>
                            </div>
                            <div class="col-sm-6 fild">
                                <input class="form-control" type="text" placeholder="{{ __('frontstaticword.enter_your_lname') }}" name="Lastname" autocomplete="off" autofocus required>
                                <label class="floating-label">{{ __('frontstaticword.lname') }}</label>
                            </div>
                            <div class="col-sm-12 fild">
                                <input class="form-control" type="email" placeholder="{{ __('frontstaticword.enter_your_email') }}" name="Email" autocomplete="off" autofocus required>
                        ...
                        <div class="fild bot-de bot-card">
                            <button class="bottom" type="submit">{{ __('frontstaticword.send') }}</button><a class="bottom" href="#" data-dismiss="modal">{{ __('frontstaticword.cancel') }} </a>
                        </div>
                    </form>
                </div>
            </div>
...
@section('footerAssets')
	...
	(function($){
		$(document).ready(function () {
			var slots_alert = "{{ __('frontstaticword.slots_alert') }}";
