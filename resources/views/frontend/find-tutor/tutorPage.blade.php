...
@section('title', __('frontstaticword.tutor_page'))
        ...
        <div class="content-all">
            <div class="row">
                <div class="col-sm-8 contenuser findinner" id="content">
                    <div class="itemtutor">
                        <div class="flex-box">
                            <div class="tu-photo">
                                ...
                                <div class="price-to">{{$currency_code}}/{{ __('frontstaticword.hour') }}</div>
                            </div>
                        ...
                        <div class="childbox">
                            <h3 class="title">{{ __('frontstaticword.about_me') }}</h3>
                            <!--<div class="headtext">
                                ...
                                <ul class="list-item">
									...
									@if($tutor->prefered_student_age->count())
										@foreach($tutor->prefered_student_age as $prefered_student_age)
											<li><i class="fas fa-circle"></i> {{$prefered_student_age->prefered_student_age->$age}}</li>
										@endforeach
									@else
                                ...
                                <ul class="list-item">
									...
									@if($tutor->prefered_student_level->count())
										@foreach($tutor->prefered_student_level as $prefered_student_level)
											<li><i class="fas fa-circle"></i> {{$prefered_student_level->prefered_student_level->$student_level}}</li>
										@endforeach
									@else
										<span class="">{{ __('frontstaticword.thereAreNoData') }}</span>
									@endif
                    ...
                    <div class="itemtutor bord-colo">
                        <h3 class="title"> {{ __('frontstaticword.schedule') }}</h3>
                                            ...
                                            @while($dayOfWeek < \Carbon\Carbon::today()->addDay(7))
                                                <div class="col innerbook">
                                                    <div class="innernum active">
                                                        <p class="sat active">{{__('frontstaticword.'.$dayOfWeek->format('l'))}}
                                                        </p>
                                                ...
                                                <div><button type="submit" id="submitBooking" name="myButton"
                                                        hidden="hidden">{{ __('frontstaticword.search') }}</button></div>
				...
				<div class="bot-de bot-card slots_sticky_footer"><button type="submit" class="bottom booknow" id="checkBtn">{{ __('frontstaticword.Submit') }}</button></div>
				</form>
                <div class="bot-show"><a class="bottom view-sce"> <span class="viw-show">{{ __('frontstaticword.view_full_schedule') }} <i
                ...
                <div class="itemtutor reviews">
                    <div class="head-rv">
                        <div class="text-rev">
                            <h3 class="title"> {{ __('frontstaticword.Reviews') }}</h3>
                            @if($averageRating != 0)
                            <ul class="rating">
                                @if($averageRating == 1)
                                <li class="fas fa-star active"></li>
                            ...
                            @endif
                            <p class="numb-rev"><span>{{$reviewCounter}}</span> {{ __('frontstaticword.Reviews') }}</p>
                        </div>
                        @php( $hasReview = false )
                        ...
                        <a class="add-rev" href="#addreview" data-toggle="modal"><i class="fas fa-plus"></i> {{ __('frontstaticword.add_review') }}</a>
                        @endif
                    </div>
                    <div class="allcomint">
                        {{--                                {{dd($tutorReviews)}}--}}
                ...
                <div class="itemtutor bord-colo">
                    <h3 class="title"> {{ __('frontstaticword.Resume') }}</h3>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" id="education-tab" data-toggle="tab"
                                ...
                                aria-selected="true">{{ __('frontstaticword.education') }}</a></li>
                        <li class="nav-item"><a class="nav-link" id="experience-tab" data-toggle="tab"
                                href="#experience" role="tab" aria-controls="experience" aria-selected="false">{{ __('frontstaticword.work_experience') }}</a></li>
                        <li class="nav-item"><a class="nav-link" id="certifications-tab" data-toggle="tab"
                                ...
                                aria-selected="false">{{ __('frontstaticword.certifications') }}</a></li>
                    </ul>
            ...
            <div class="col-sm-4 contenuser sidbar">
                <div id="sidebar">
					...
					@if(Auth::check() && Auth::user()->role == 'user' || Auth::guest())
					<div class="bot-de bot-card"><a class="bottom book-trial" href="#booktrial" data-toggle="modal">{{ __('frontstaticword.book_now') }}</a><a class="bottom" href="#sendmessage" data-toggle="modal">{{ __('frontstaticword.send_message') }} </a></div>
                    <p class="timezone">
                        ...
                        </svg>{{ __('frontstaticword.usually_response_in_5_hrs') }}
                    </p>
					@endif
...
<div class="modal fade" id="addreview" role="dialog">
    <div class="modal-dialog popreview">
        <div class="modal-content">
            ...
            <h3 class="title">{{ __('frontstaticword.add_review') }}</h3>
            <form action="/reviewrating" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-12 fild">
                        ...
                        <label class="floating-label">{{ __('frontstaticword.review') }}</label>
                    </div>
                    @if(auth()->check())
                    ...
                    <div class="col-sm-12 fild">
                        <h3 class="title charact">{{ __('frontstaticword.characteristics_of_a_tutor') }}</h3>
                        <div class="row">
                            <div class="col">
                                <div class="rev-item" name="">
                                    <p>{{ __('frontstaticword.effectiveness') }}</p>
                                    <ul class="stars">
                                ...
                                <div class="rev-item">
                                    <p>{{ __('frontstaticword.methodology') }}</p>
                                    <ul class="stars">
                                        <li value="1" class="star" title="" data-value="1"><i class="fas fa-star"></i>
                                        </li>
                                        <li value="2" class="star" title="" data-value="2"><i class="fas fa-star"></i>
                                ...
                                <div class="rev-item">
                                    <p>{{ __('frontstaticword.motivation') }}</p>
                                    <ul class="stars">
                                        <li value="1" class="star" title="" data-value="1"><i class="fas fa-star"></i>
                                        </li>
                                        <li value="2" class="star" title="" data-value="2"><i class="fas fa-star"></i>
                            ...
                            <div class="col">
                                <div class="rev-item">
                                    <p>{{ __('frontstaticword.interpersonal_skills') }}</p>
                                    <ul class="stars">
                                        <li value="1" class="star" title="" data-value="1"><i class="fas fa-star"></i>
                                        </li>
                                        <li value="2" class="star" title="" data-value="2"><i class="fas fa-star"></i>
                                ...
                                <div class="rev-item">
                                    <p>{{ __('frontstaticword.strictness') }}</p>
                                    <ul class="stars">
                                        <li value="1" class="star" title="" data-value="1"><i class="fas fa-star"></i>
                                        </li>
                                        <li value="2" class="star" title="" data-value="2"><i class="fas fa-star"></i>
                                ...
                                <div class="rev-item">
                                    <p>{{ __('frontstaticword.punctuality') }}</p>
                                    <ul class="stars">
                                        <li value="1" class="star" title="" data-value="1"><i class="fas fa-star"></i>
                                        </li>
                                        <li value="2" class="star" title="" data-value="2"><i class="fas fa-star"></i>
                ...
                <div class="fild bot-de bot-card">
                    <button class="bottom" type="submit">{{ __('frontstaticword.post_review') }}</button><a class="bottom" href="#"
            ...
            <form action="{{ route('messages.store') }}" method="POST">
                ...
                <div class="fild bot-de bot-card">
                    <button class="bottom" type="submit">{{ __('frontstaticword.send') }}</button> <a class="bottom"
                        href="#" data-dismiss="modal">{{ __('frontstaticword.cancel') }} </a>
                </div>
            </form>
        </div>
    </div>
...
<div class="box-book-trial" id="#booktrial">
    ...
    <div class="bot-de bot-card modal_sticky_footer">
        <button type="submit" class="bottom booknow" id="checkBtnModal">{{ __('frontstaticword.Submit') }}</button>
