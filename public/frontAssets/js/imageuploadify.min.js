...
(function ($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function (opts) {
        ...
        this.each(function () {
            ...
            let totalFiles = [];
            let counter = 0;
            //let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><div class="imageupbox"> <span class='imageuploadify-message'>Drag or Drop your photo here</span><button type="button"class="btn btn-default">Upload Photo</button> <p class="textsacand"><i class="fas fa-info-circle"></i> JPG or PNG format  Maximum 5 MB </p></div></div></div>`);
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><div class="imageupbox"> <span class='imageuploadify-message'>Drag or Drop your photo here</span><button type="button"class="btn btn-default">Upload Photo</button> </div></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger fas fa-times'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
            ...
            $(self).closest("form").on("submit", function (event) {
                ...
                xhr.onreadystatechange = function (e) {
                    if (xhr.status == 1 && xhr.readyState === XMLHttpRequest.DONE) {
