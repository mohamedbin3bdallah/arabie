...
class Instructor extends Model
{
    ...
    protected $fillable = [ 'user_id', 'headline', 'detail', 'specialty', 'preferedStudentLevel','PreferredStudentAge', 'file', 'status', 'recommendation', 'PricePerHour', 'viewed', 'video','active_students'];
