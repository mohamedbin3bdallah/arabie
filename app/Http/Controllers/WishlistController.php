...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request,$id)
    {
        ...
        if(isset($orders)){
            ...
            return back()->with('delete',__('adminstaticword.you_already_purchased_this_course'));
        }
        else{


            if(!empty($wishlist)){
                return back()->with('delete',__('adminstaticword.course_is_already_in_wishlist'));
            }
            else{
            ...
            return back()->with('success',__('adminstaticword.course_is_added_to_your_wishlist'));
        }
