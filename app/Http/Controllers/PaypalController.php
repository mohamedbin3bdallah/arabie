...
class PaypalController extends Controller
{
    ...
    {	
		...
		\Session::put('error', __('adminstaticword.connection_timeout'));
		                return Redirect::route('paywithpaypal');
		} else {
		\Session::put('error', __('adminstaticword.error'));
		                return Redirect::route('paywithpaypal');
		}
		}
	...
	public function getPaymentStatus(Request $request)
    {
		...
		/** clear the session payment ID **/
		        ...
		        if (empty($request->get('PayerID')) || empty($request->get('token')))
		         ...
		         {
		\Session::put('error', __('adminstaticword.payment_failed'));
		   	...
		   	{ 
		        ...
		        if($created_order){
					try{
						...
						Session::flash('deleted',__('adminstaticword.payment_received_successfully').' '.__('adminstaticword.but').' '.__('adminstaticword.invoice').' '.__('adminstaticword.email_will_not_sent_because_of_error_in_mail_configuration'));
						return redirect('/');
					}
				}
        ...
        \Session::flash('success', __('adminstaticword.payment_success'));
		    return redirect('/');
		}
		\Session::flash('delete', __('adminstaticword.payment_failed'));
		    return redirect('/');
	}
}
