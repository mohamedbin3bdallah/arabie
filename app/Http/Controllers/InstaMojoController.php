	        ...
	        if($created_order){
	        	if (env('MAIL_USERNAME')!=null) {
					try{
						...
						Session::flash('deleted',__('adminstaticword.payment_received_successfully').' '.__('adminstaticword.but').' '.__('adminstaticword.email_will_not_sent_because_of_error_in_mail_configuration'));
						return redirect('/');
					}
				}
			}
