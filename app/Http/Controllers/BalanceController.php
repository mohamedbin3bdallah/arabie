...
class BalanceController extends Controller
{
    ...
    public function update(Request $request)
    {
		...
		if($usertutorbalance && $usertutorbalance->balance > 0)
		{
			...
			*/
			...
			Session::flash('success',__('adminstaticword.action_done_successfully'));
			return redirect('/mylessons/'.\Auth::user()->id);
		}
		else
		{
			Session::flash('error',__('adminstaticword.you_dont_have_balance'));
            return redirect('/mylessons/'.\Auth::user()->id);
		}
	}
	...
	*/
	public function updateSlots(Request $request)
    {
		...
		{
            return back()->with('error', __('adminstaticword.you_dont_have_balance'));
		}
	}
