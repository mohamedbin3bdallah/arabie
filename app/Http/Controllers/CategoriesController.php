...
{   
    ...
    public function destroy($id)
    {
        if(Auth::User()->role == "admin"){
            ...
            if(!$course->isEmpty())
            {
                return back()->with('delete',__('adminstaticword.cannot_delete_because_relationship'));
            }
            else{
    ...
    public function reposition(Request $request)
    {
        ...
        return response()->json(['msg'=>__('adminstaticword.updated_successfully'), 'success'=>true]);
