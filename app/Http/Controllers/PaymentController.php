...
class PaymentController extends Controller
{
        ...
        if($user->prefer_pay_method == "paypal")
        {
              ...
              try
              {
                ...
                if($errorcode == 422){
                    ...
                    Session::flash('delete',__('adminstaticword.check_your_paypal_account'));
                    return view('admins/instructor');
                 }

                 if($errorcode == 400){

                    Session::flash('delete',__('adminstaticword.currency_not_supported_in_paypal'));
                    return view('admins/instructor');
                 }
	...
	*/
	public function success(){
		...
		{
			Session::flash('error',__('adminstaticword.payment_failed'));
			return redirect('/');
        }
		else
		{
