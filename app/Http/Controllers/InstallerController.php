...
class InstallerController extends Controller
{
    ...
    public function step2(Request $request){
        ...
        }catch(\Exception $e)
        {
          ...
          $errorcode = $e->getCode();
           if($errorcode){
              Session::flash('delete',__('adminstaticword.invalid_database_details_please_check'));
              return view('install.step2');
           }
        }
    ...
    public function getstep3(){
      ...
      try
        ...
        catch(\Exception $e)
        {
            ...
            {
              Session::flash('delete',__('adminstaticword.error_connecting_in_database_please_check_details'));
              return redirect()->route('get.step2');
            ...
            if ($errorcode == 2002 )
            {
              Session::flash('delete',__('adminstaticword.invalid_database_host_or_port'));
              return redirect()->route('get.step2');
            }

            Session::flash('delete',__('adminstaticword.error_connecting_to_database'));
  ...
  public function update_status($status)
    {
        ...
        if (curl_errno($ch) > 0)
        {
            $message = __('adminstaticword.error_connecting_to_api');
            return 2;
        }
