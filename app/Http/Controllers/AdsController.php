...
class AdsController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	$newad->save();
    	return back()->with('success',__('adminstaticword.created_successfully'));
      ...
      if ($file = $request->file('ad_image'))
         {
          ...
          return redirect()->route('ads')->with('success',__('adminstaticword.updated_successfully'));
    ...
    public function bulk_delete(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return back()->with('delete', __('adminstaticword.please_select_one_of_them'));
        }
