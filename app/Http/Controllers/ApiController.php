...
class ApiController extends Controller
{
    ...
    public function setApiView()
    {
        ...
        $env_files = [
            ...
            'AWS_URL' => env('AWS_URL'),
            'VAPULUS_WEBSITE_ID' => env('VAPULUS_WEBSITE_ID'),
            'VAPULUS_MERCHANT_ID' => env('VAPULUS_MERCHANT_ID'),
        ];
    ...
    public function changeEnvKeys(Request $request)
    {
        ...
        $env_update = $this->changeEnv([
            ...
            'VAPULUS_WEBSITE_ID' => $input['VAPULUS_WEBSITE_ID'],
            'VAPULUS_MERCHANT_ID' => $input['VAPULUS_MERCHANT_ID'],
        ]);
        ...
        if(isset($request->vapulus_check))
        {
            $setting->vapulus_enabled = "1";
        }else
        {
            $setting->vapulus_enabled = "0";
        }
