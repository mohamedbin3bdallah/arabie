...
class InstructorSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('instructor.settings')->with('success',__('adminstaticword.updated_successfully'));
    }
    ...
    public function settings(Request $request, $id)
    {
        ...
        $user->save();
        return redirect()->route('instructor.pay')->with('success',__('adminstaticword.updated_successfully'));
    }
