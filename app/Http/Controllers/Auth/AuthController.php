...
class AuthController extends Controller
{
    ...
    public function handleProviderCallback($provider, $type, Request $request)
    {
        ...
        if($authUser == '-1'){
            ...
            return redirect()->intended('/login')->with('error',__('adminstaticword.user_not_exist_please_register_first'));
    ...
    public function findOrCreateUser($user, $provider, $type)
    {
        if($user->email == Null){
            ...
            return redirect()->intended('/login')->with('error',__('adminstaticword.no_email_returned_from_facebook'));
        }
