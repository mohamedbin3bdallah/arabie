...
class CourseController extends Controller
{
    ...
    public function destroy($id)
    {
      ...
      if(config('app.demolock') == 0){
        ...
        if(!$order->isEmpty())
        {
          return back()->with('delete',__('adminstaticword.users_are_enrolled_in_course'));
        }
        else{
      ...
      {
        return back()->with('delete',__('adminstaticword.you_cannot_delete_courses_in_demo'));
      }
    ...
    public function CourseContentPage($id)
    {
      ...
      return Redirect::route('login')->withInput()->with('delete', __('adminstaticword.you_have_to_login_to_access_this_area')); 
