...
//dd($validator);
        ...
        return redirect("coupon")->with("success",__('adminstaticword.created_successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("coupon")->with("success",__('adminstaticword.updated_successfully'));
    }
    ...
    public function destroy($id)
    {
        ...
        if(isset($newc)){
            $newc->delete();
            return back()->with('success',__('adminstaticword.deleted_successfully'));
        }else{
            return back()->with('delete','404 | '.__('adminstaticword.item_is_already_exist'));
        }
    }
}
