        ...
        if (isset($request->userId))
        {
            ...
            if(env('MAIL_USERNAME')!=null) {
                try{
                    ...
                    /*sending email*/
                    $x = 'Kindly be informed that a new review has been added to your profile page.';
                    $y = 'Kindly be informed that your review has been added to your tutor profile page';
//                    dd($request->user);
...
//        if(env('MAIL_USERNAME')!=null) {
            try{
                ...
                /*sending email*/
                $x = 'Kindly be informed that a new review has been added to your lessons page.';
...
//        }
    ...
    public function rating(Request $request,$id)
    {
        ...
        if(!empty($orders)){
            if(!empty($review))
            {
                return back()->with('delete',__('adminstaticword.you_already_reviewed_this_course'));
            }
            else{
                ...
                return back()->with('success',__('adminstaticword.action_done_successfully'));
            }
            return back()->with('success',__('adminstaticword.action_done_successfully'));
        }
        else{
            return back()->with('delete',__('adminstaticword.purchase_to_review_this_course'));
