...
class MessagesController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            Session::flash('error_message', __('adminstaticword.record_not_found'));
    ...
    public function store()
    {
        ...
        if ($input['message'] == null){
            session()->flash("error",__('adminstaticword.enter_you_message'));
    ...
    public function studentMessage(Request $request)
    {
        ...
        $thread = Messenger_thread::create(
            [
                //'subject' => $input['subject'],
                'subject' => ($user->role == 'user')? 'Message To Tutor':'Message To Student',
