...
class AdsenseController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if(isset($ad))
        {
          ...
          if($ad->status = 'on')
          {
            return redirect()->route('adsense')->with('updated',__('adminstaticword.its_now_active'));
            
          }
          else 
          {
            return redirect()->route('adsense')->with('updated',__('adminstaticword.its_now_deactive'));
